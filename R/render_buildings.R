...
#' render_camera(fov = 120,zoom=0.7)
#'
...
#' render_highquality(
#'	camera_location = c(-8.17, 7.70, 15.09),
#'	camera_lookat = c(-1.09, -2.25, -3.63),
#'	samples = 100,
#'	iso = 100 / 30,
#'	datetime = as.POSIXct("2025-01-01 14:00:00", tz = "America/St_Johns"),
