...
#'@param title_text Default `NULL`. Text. Adds a title to the movie, using magick::image_annotate. Change
#'the position, color, and size by passing the appropriate argument to ... from magick::image_annotate.
