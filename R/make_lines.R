...
make_lines = function(
  ...
  if (all(!is.na(heightmap))) {
    if (solid) {
      ...
      if (basedepth > heightval1) {
        heightlist[[counter]] = matrix(
          c(1, 1, basedepth, heightval1, 1, 1),
          2,
          3
        )
        counter = counter + 1
      ...
      if (basedepth > heightval2) {
        heightlist[[counter]] = matrix(
          c(nr, nr, basedepth, heightval2, 1, 1),
          2,
          3
        )
        counter = counter + 1
      ...
      if (basedepth > heightval3) {
        heightlist[[counter]] = matrix(
          c(1, 1, basedepth, heightval3, nc, nc),
          2,
          3
        )
        counter = counter + 1
      ...
      if (basedepth > heightval4) {
        heightlist[[counter]] = matrix(
          c(nr, nr, basedepth, heightval4, nc, nc),
          2,
          3
        )
        counter = counter + 1
  ...
  if (length(heightlist) > 0) {
    ...
    rgl::segments3d(
      ...
      depth_test = "lequal",
      tag = ifelse(solid, "lines", "waterlines")
    )
  }
}
