...
#'@param basealpha Default `1`. Transparency.
#'@keywords internal
make_base = function(heightmap,basedepth=0,basecolor="grey20",zscale=1,basealpha=1) {
  ...
  if(all(!is.na(heightmap))) {
    ...
    rgl::triangles3d(fullsides,lit=FALSE,color=basecolor,front="filled",back="filled",ambient = "#000002",alpha=basealpha)
  } else {
    fullsides = do.call(rbind,heightlist)
