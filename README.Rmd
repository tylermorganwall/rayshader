...
render_label(montereybay,x=350,y=240, z=4000,zscale=50,text = "Moss Landing",textsize = 2,linewidth = 5)
render_label(montereybay,x=220,y=330, z=6000,zscale=50,text = "Santa Cruz",color="darkred",textcolor = "darkred",textsize = 2,linewidth = 5)
render_label(montereybay,x=300,y=130, z=4000,zscale=50,text = "Monterey",dashed = TRUE,textsize = 2,linewidth = 5)
render_label(montereybay,x=50,y=130, z=1000,zscale=50,text = "Monterey Canyon",relativez=FALSE,textsize = 2,linewidth = 5)

rgl::snapshot3d("preview3.png")
png::readPNG("preview3.png") %>%
  plot_map()
rgl::rgl.close()
```
...
render_depth(focus=0.6,focallength = 200,filename="depth2.png")
