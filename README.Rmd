...
- `render_obj()` adds a 3D OBJ model to the current scene, using x/y coordinates in the reference system defined by the extent object.
- `render_raymesh()` adds a 3D `ray_mesh` model to the current scene, using x/y coordinates in the reference system defined by the extent object.
