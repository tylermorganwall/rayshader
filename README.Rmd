...
montereybay %>%
    ...
    plot_3d(montereybay, zscale = 50, fov = 70, theta = -45, phi = 20, 
            ...
            waterlinecolor = "white", waterlinealpha = 0.5)
Sys.sleep(0.2)
render_highquality(lightdirection = 0, lightangle = 30, clamp_value = 10, clear=TRUE)
...
3D ggplots can also be visualized with `render_highquality()`, but often it's faster to reduce their size first. We can do that with the built-in `reduce_size` argument to `plot_gg()`. Here, we reduce the size of the plot by a factor of 2.
