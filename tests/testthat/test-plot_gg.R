...
test_that("plot_gg() doesn't error", {
  ...
  expect_warning(plot_gg(ggvolcano_surface, ggobj_height = ggvolcano,
  ...
  expect_no_condition(plot_gg(mtplot, width=3.5, sunangle=225, preview = TRUE))
  ...
  expect_no_condition(plot_gg(mtplot_density_facet, width = 6, windowsize=c(1400,866),
